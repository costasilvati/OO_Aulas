...
\mode<presentation>{\begin{frame}{Atividade}
  Seja o compilador.\\
  Responda se cada bloco, compila ou não. Caso não, qual o motivo?
  \begin{center} 
   \includegraphics[height=0.6\paperheight]{compila.png} \\
 \end{center}
\end{frame}}
%----------------------------------------------------------------------------
\mode<presentation>{\section{Arrays}
\begin{frame}{Array}
 \begin{center} 
...
\end{frame}}
%----------------------------------------------------------------------
\mode<presentation>{\begin{frame}{Atividade - parte II}
...
\begin{center} 
   \includegraphics[height=0.2\paperheight]{aula6_atv2.png} \\
 \end{center}
\end{frame}}
%-----------------------------------------------------
\mode<presentation>{\begin{frame}{Atividades}
