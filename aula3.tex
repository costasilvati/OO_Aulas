...
%----------------------------------------------------------------------------
\section{Arrays}
\mode<presentation>{\begin{frame}{Array - Definição}
 \begin{center} 
...
\end{frame}}
%----------------------------------------------------------------------
\mode<presentation>{\begin{frame}{Array - Obrigatoriedades}
...
\end{frame}}
%----------------------------------------------------------------------
\mode<presentation>{\begin{frame}{Array - tamanho}
...
\mode<presentation>{\begin{frame}{Atividades}
  \textbf{1.} Faça um programa em Java que mostre a tabuada de um número escolhido pelo usuário (entre 1 e 10) \textit{Obrigatório o uso de laço de repetição}. Repita o exercício cm os 3 laços.\\
\vspace{0.5cm}
\textbf{2.} Faça um programa em Java que mostre a tabuada de 1 a 10 em uma mesma tela. De 1 a 5 no primeiro bloco e do 6 ao 10 no segundo. \textit{Obrigatório o uso de laço de repetição}.
\end{frame}}
%----------------------------------------------------------------------
\mode<presentation>{\begin{frame}{Atividades}

  \textbf{3.} Faça um programa em Java que calcule o fatorial de um número pré-definido. \textit{Obrigatório o uso de laço de repetição}.\\
\vspace{0.5cm}
\end{frame}}
%----------------------------------------------------------------------
\section{Atividades}
\mode<presentation>{\begin{frame}{Atividades}
  \textbf{4.} Escreva uma aplicação capaz de receber 10 números (tipo ponto flutuante), calcule e imprima: 
\begin{itemize}
 ...
 \item O menor número.
\end{itemize}
\textit{Obrigatório o uso de laço de repetição array}.
\end{frame}}
%----------------------------------------------------------------------
\mode<presentation>{\begin{frame}{Atividades}
\small
...
%-----------------------------------------------------
\mode<presentation>{\begin{frame}{Atividades}
  \textbf{8.} Escreva uma aplicação que receba do usuário uma frase no seguinte formato N-N-N-...-N-N-N (representando por números inteiros separados por hífen), extraia esses números desta frase e crie e alimente um vetor de tamanho exato a quantidade de números. De posse desses números, coloque-os em ordem decrescente no vetor.
\end{frame}}

%----------------------------------------------------------------------
\mode<presentation>{\begin{frame}{Atividades}
  \textbf{9.} Faça uma aplicação que receba uma frase e retorne o texto invertido.\\
\textbf{10.} Faça uma aplicação que receba o nome completo do usuário, e depois troque o seu último sobrenome por Silva. Mostre o resultado na tela.
\end{frame}}
%------------------------------
