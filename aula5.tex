...
criados a partir daquela classe.
   \pause \item Existe apenas uma única cópia do método e/ ou atributo que esta 
...
variáveis de instância;
      \pause \item um método estático, \textbf{\textcolor{blue}{NÃO}} pode se 
...
(String), seu RG (String) e um valor booleano que indique se o funcionário está 
na empresa no momento ou se já foi embora. Você deve criar alguns métodos de  
