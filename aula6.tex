...
% \section{Introdução}
 ...
 \begin{itemize}
  \item Objetos estáticos;
  \item Classes estáticas;
  \end{itemize}
\end{frame}
}
%-------------------------------------------------------------------------
...
\section{Herança}
 ...
 \end{block}
 \begin{center}
     \includegraphics[height=0.3\paperheight]{fig/heranca.png}
 \end{center}
 
% \small{ \lstinputlisting[linerange={1-13}{./cod/Banco/noExtended/Gerente.java}}
\end{frame}
}
%----------------------------------------------------------------------
 \mode<presentation>{ 
