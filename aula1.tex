...
\subtitle{Aula 1 - Introdução a linguagem Java}
...
\begin{frame}{Sobre a Disciplina}
  ...
  \begin{block}{\textbf{Atenção!}}
    \begin{itemize}
      \item Segunda e Sexta-feira (19 as 20:25 hs e 20:45 as 21:50 hs) - 4 aulas;
       \item 60 hs semestre;
       \item Frequência mínima 75\% (Máximo de 30 faltas);
    \end{itemize}	
  \end{block}
\end{frame}}
%-------------------------------------------------------------------
